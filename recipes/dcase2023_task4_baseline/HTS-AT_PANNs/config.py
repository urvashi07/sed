...
loss_type_frame = "clip_bce"  #mse or clip_ce
loss_type_class = "clip_bce"  #mse or clip_ce
...
batch_size = 4  # batch size per GPU x GPU number , default is 32 x 4 = 128
learning_rate = 1e-4  # 1e-3 also workable
max_epoch = 2
num_workers = 0
...
# for data collection
classes_num = 10  # esc: 50 | audioset: 527 | scv2: 35
...
prefix_folder = "/nm-raid/audio/work/unegi"

swin_pretrain_path = os.path.join(
    prefix_folder, "ckpt_hts-at", "HTSAT_AudioSet_Saved_4.ckpt"
)
panns_pretrain_path = os.path.join(
    prefix_folder, "ckpt_panns", "Cnn14_DecisionLevelAtt_mAP0.425.pth"
)
...
esm_model_pathes = [
    "./ckpt/HTSAT_AudioSet_Saved_1.ckpt",
    "./ckpt/HTSAT_AudioSet_Saved_2.ckpt",
    "./ckpt/HTSAT_AudioSet_Saved_3.ckpt",
    "./ckpt/HTSAT_AudioSet_Saved_4.ckpt",
    "./ckpt/HTSAT_AudioSet_Saved_5.ckpt",
    "./ckpt/HTSAT_AudioSet_Saved_6.ckpt",
]
