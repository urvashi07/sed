...
class SEDWrapper(pl.LightningModule):
    def __init__(self, sed_model, config):
        ...
        #self.f1_metric = F1Score(task="multiclass", num_classes=config.classes_num)
        ...
        if self.config.dataset_type == "audioset":
            ...
            return {"mAP": mAP, "mAUC": mAUC, "dprime": dprime, 
                    #"precision": precision, "recall": recall,
                     "f1": f1}#, "confusion_matrix": confusion_matrix}
        else:
    ...
    def validation_epoch_end(self, validation_step_outputs):
        ...
        if torch.cuda.device_count() > 1:
            ...
            if self.config.dataset_type == "audioset":
                ...
                self.log("f1", metric_dict["f1"], on_epoch = True, prog_bar=True, sync_dist=False)
